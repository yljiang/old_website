	...
	$(function() {
		...
		//Fill Gallery with Images
			...
			for (var i=1; i<= images; i++){
				$('.gallery.lightbox')
					.append('<article><a href="images/gallery/photography/' + i + '.jpg" class="image"><img src="images/gallery/thumbs/' + i + '.jpg" alt="" /></a></article>')
			}
					...
					.on('mouseenter', '.forward, .backward', function(event) {
						...
						// Start interval.
							this._gallery_moveIntervalId = setInterval(function() {
								$inner.scrollLeft( $inner.scrollLeft() + (7 * direction) );
							}, 10);
